  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        {/* Left Column: Subtasks, Tags, Attachments, Comments */}
        <div className="flex flex-col gap-6 border p-4 rounded-md bg-white shadow-md">
          <div>
        ...
        <div className="flex flex-col gap-6 border p-6 rounded-xl bg-gradient-to-br from-white via-blue-50 to-blue-100 shadow-lg">
        ...
        {/* Right Column: Project info (top), Activity (bottom) */}
        <div className="flex flex-col gap-6 h-full">
          {/* Project Info */}
          <div className="border p-4 rounded-xl bg-gradient-to-br from-blue-50 to-blue-100 border-blue-200 shadow mb-4">
          ...
          {/* Activity */}
          <div className="border p-4 rounded-xl bg-white shadow flex-1">
            <span className="font-semibold text-gray-600">Activity:</span>
